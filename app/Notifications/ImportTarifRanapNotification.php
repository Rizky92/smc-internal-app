...
class ImportTarifRanapNotification extends Notification
{
    use Queueable;
     ...
     * @return void
     */
    public function __construct($user, $message, $status, ?string $file = null)
    {
        $this->user = $user;
    ...
    /**
     * Ensure the given string is UTF-8 encoded.
     *
     * @param  string  $value
     * @return string
     */
