...
pasien.alamat,
pasien.tgl_lahir,
(select diagnosa_pasien.kd_penyakit from diagnosa_pasien where diagnosa_pasien.no_rawat = reg_periksa.no_rawat and diagnosa_pasien.prioritas = '1' order by diagnosa_pasien.status desc limit 1) kd_penyakit,
(select penyakit.nm_penyakit from diagnosa_pasien join penyakit on diagnosa_pasien.kd_penyakit = penyakit.kd_penyakit where diagnosa_pasien.no_rawat = reg_periksa.no_rawat and diagnosa_pasien.prioritas = '1' order by diagnosa_pasien.status desc limit 1) nm_penyakit,
pasien.pnd,
