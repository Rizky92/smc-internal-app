    ...
    public function scopePemakaianStok(Builder $query): Builder
    {
        $sqlSelect = <<<SQL
            ...
            (
                ...
                ifnull((select round(sum(detreturjual.jml_retur), 2) from detreturjual join returjual on detreturjual.no_retur_jual = returjual.no_retur_jual where detreturjual.kode_brng = databarang.kode_brng and returjual.tgl_retur between date_sub(current_date(),interval 2 week) and current_date()),0)
            )
            ke_pasien_14_hari,
            (
                ...
                ifnull((select round(sum(detreturjual.jml_retur), 2) from detreturjual join returjual on detreturjual.no_retur_jual = returjual.no_retur_jual where detreturjual.kode_brng = databarang.kode_brng and returjual.tgl_retur between date_sub(current_date(),interval 1 week) and current_date()),0)
            ) pemakaian_1_minggu,
            (
                ...
                ifnull((select round(sum(detreturjual.jml_retur), 2) from detreturjual join returjual on detreturjual.no_retur_jual = returjual.no_retur_jual where detreturjual.kode_brng = databarang.kode_brng and returjual.tgl_retur between date_sub(current_date(),interval 1 month) and current_date()),0)
            ) pemakaian_1_bulan,
            (
                ...
                ifnull((select round(sum(detreturjual.jml_retur), 2) from detreturjual join returjual on detreturjual.no_retur_jual = returjual.no_retur_jual where detreturjual.kode_brng = databarang.kode_brng and returjual.tgl_retur between date_sub(current_date(),interval 3 month) and current_date()),0)
            ) pemakaian_3_bulan,
            (
                ...
                ifnull((select round(sum(detreturjual.jml_retur), 2) from detreturjual join returjual on detreturjual.no_retur_jual = returjual.no_retur_jual where detreturjual.kode_brng = databarang.kode_brng and returjual.tgl_retur between date_sub(current_date(),interval 10 month) and current_date()),0)
            ) pemakaian_10_bulan,
            (
                ...
                ifnull((select round(sum(detreturjual.jml_retur), 2) from detreturjual join returjual on detreturjual.no_retur_jual = returjual.no_retur_jual where detreturjual.kode_brng = databarang.kode_brng and returjual.tgl_retur between date_sub(current_date(),interval 12 month) and current_date()),0)
            ) pemakaian_12_bulan
        SQL;
