...
class ResetPasswordUserModal extends Component
{
    ...
    {
        return view('livewire.user.khanza.reset-password-user-modal')
            ->layout(BaseLayout::class, ['title' => Str::title('ResetPasswordUserModal')]);
    }
