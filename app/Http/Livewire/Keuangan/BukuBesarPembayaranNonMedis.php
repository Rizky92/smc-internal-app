...
class BukuBesarPembayaranNonMedis extends Component
{
    ...
    {
        return view('livewire.keuangan.buku-besar-pembayaran-non-medis')
            ->layout(BaseLayout::class, ['title' => Str::title('BukuBesarPembayaranNonMedis')]);
    }
