...
class StatusDataPasien extends Component
{
        ...
        return [
            RegistrasiPasien::query()
                ...
                ->map(fn (RegistrasiPasien $modal): array => [
                    ...
                    'askep_poli_umum'           => boolval($modal->askep_poli_umum) ? 'Ada' : 'Tidak ada',
                    'askep_poli_anak'           => boolval($modal->askep_poli_anak) ? 'Ada' : 'Tidak ada',
                    'askep_poli_bedah'          => boolval($modal->askep_poli_bedah) ? 'Ada' : 'Tidak ada',
                    'askep_poli_bedah_mulut'    => boolval($modal->askep_poli_bedah_mulut) ? 'Ada' : 'Tidak ada',
                    'askep_poli_kandungan'      => boolval($modal->askep_poli_kandungan) ? 'Ada' : 'Tidak ada',
                    'askep_poli_mata'           => boolval($modal->askep_poli_mata) ? 'Ada' : 'Tidak ada',
                    'askep_poli_neurologi'      => boolval($modal->askep_poli_neurologi) ? 'Ada' : 'Tidak ada',
                    'askep_poli_orthopedi'      => boolval($modal->askep_poli_orthopedi) ? 'Ada' : 'Tidak ada',
                    'askep_poli_penyakit_dalam' => boolval($modal->askep_poli_penyakit_dalam) ? 'Ada' : 'Tidak ada',
                    'askep_poli_psikiatrik'     => boolval($modal->askep_poli_psikiatrik) ? 'Ada' : 'Tidak ada',
                    'askep_poli_tht'            => boolval($modal->askep_poli_tht) ? 'Ada' : 'Tidak ada',
                    'askep_ranap_umum'          => boolval($modal->askep_ranap_umum) ? 'Ada' : 'Tidak ada',
                    'askep_ranap_kandungan'     => boolval($modal->askep_ranap_kandungan) ? 'Ada' : 'Tidak ada',
    ...
    protected function columnHeaders(): array
    {
        return [
            ...
            'Askep Poli Anak',
            'Askep Poli Bedah',
            'Askep Poli Bedah Mulut',
            'Askep Poli Kandungan',
            'Askep Poli Mata',
            'Askep Poli Neurologi',
            'Askep Poli Orthopedi',
            'Askep Poli Penyakit Dalam',
            'Askep Poli Psikiatrik',
            'Askep Poli THT',
            'Askep Ranap Umum',
            'Askep Ranap Kandungan',
            'ICD 10',
            'ICD 9',
        ];
    }
