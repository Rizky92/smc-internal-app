        ...
        return [
            fn () => Obat::query()
                ...
                ->map(fn (Obat $model): array => [
                    ...
                    'stok_sekarang_gf'      => $model->stok_sekarang_gf,
                    'stok_sekarang_ifo'     => $model->stok_sekarang_ifo,
                    ...
                    'total_stok_sekarang'   => $model->stok_sekarang_ifi + $model->stok_sekarang_ap + $model->stok_sekarang_ifg + $model->stok_sekarang_gf + $model->stok_sekarang_ifo,
