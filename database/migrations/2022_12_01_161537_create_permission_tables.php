...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::connection('mysql_smc')->create($tableNames['model_has_permissions'], function (Blueprint $table) use ($tableNames, $columnNames, $teams) {
            ...
            $table->string($columnNames['model_morph_key'], 700);
    ...
    public function down()
    {
        ...
        Schema::connection('mysql_smc')->drop($tableNames['role_has_permissions']);
        Schema::connection('mysql_smc')->drop($tableNames['model_has_roles']);
        Schema::connection('mysql_smc')->drop($tableNames['model_has_permissions']);
