...
namespace Tests\Feature\Livewire\Admission;

use App\Livewire\Pages\Admission\AntreanOnsite;
 ...
 */
class AntreanOnsiteTest extends TestCase
{
    private const PERMISSION = 'antrean.antrean-onsite.read';

    private function report()
    {
        $petugas = $this->petugasWithPermissions([self::PERMISSION], '99999901');

        return Livewire::actingAs($petugas)->test(AntreanOnsite::class);
    }
