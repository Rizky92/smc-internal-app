...
use App\Livewire\Pages\RekamMedis\StatusDataPasien;
 ...
 */
class StatusDataPasienTest extends TestCase
{
    private const PERMISSION = 'rekam-medis.status-data-pasien.read';

    private function report()
    {
        $petugas = $this->petugasWithPermissions([self::PERMISSION], '99999901');

        return Livewire::actingAs($petugas)->test(StatusDataPasien::class);
    }
