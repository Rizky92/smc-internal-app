...
use App\Livewire\Pages\Casemix\LaporanPasienRanapPulang;
 ...
 */
class LaporanPasienRanapPulangTest extends TestCase
{
    private const PERMISSION = 'casemix.laporan-pasien-ranap-pulang.read';

    private function report()
    {
        $petugas = $this->petugasWithPermissions([self::PERMISSION], '99999901');

        return Livewire::actingAs($petugas)->test(LaporanPasienRanapPulang::class);
    }
