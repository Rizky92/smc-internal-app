...
use App\Livewire\Pages\Casemix\LaporanPasienCob;
 ...
 */
class LaporanPasienCobTest extends TestCase
{
    private const PERMISSION = 'casemix.laporan-pasien-cob.read';

    private function report()
    {
        $petugas = $this->petugasWithPermissions([self::PERMISSION], '99999901');

        return Livewire::actingAs($petugas)->test(LaporanPasienCob::class);
    }
