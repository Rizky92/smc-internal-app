...
use App\Livewire\Pages\Casemix\LaporanTriaseIgdZonaHijau;
 ...
 */
class LaporanTriaseIgdZonaHijauTest extends TestCase
{
    private const PERMISSION = 'casemix.laporan-triase-igd-zona-hijau.read';

    private function report()
    {
        $petugas = $this->petugasWithPermissions([self::PERMISSION], '99999901');

        return Livewire::actingAs($petugas)->test(LaporanTriaseIgdZonaHijau::class);
    }
