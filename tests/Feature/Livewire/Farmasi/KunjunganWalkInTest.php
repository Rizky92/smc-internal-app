...
use App\Livewire\Pages\Farmasi\KunjunganWalkIn;
 ...
 */
class KunjunganWalkInTest extends TestCase
{
    private const PERMISSION = 'farmasi.kunjungan-walk-in.read';

    private function report()
    {
        $petugas = $this->petugasWithPermissions([self::PERMISSION], '99999901');

        return Livewire::actingAs($petugas)->test(KunjunganWalkIn::class);
    }
