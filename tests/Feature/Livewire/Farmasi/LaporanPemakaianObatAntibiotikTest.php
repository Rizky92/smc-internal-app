...
use App\Livewire\Pages\Farmasi\LaporanPemakaianObatAntibiotik;
 ...
 */
class LaporanPemakaianObatAntibiotikTest extends TestCase
{
    private const PERMISSION = 'farmasi.laporan-pemakaian-obat-antibiotik.read';

    private function report()
    {
        $petugas = $this->petugasWithPermissions([self::PERMISSION], '99999901');

        return Livewire::actingAs($petugas)->test(LaporanPemakaianObatAntibiotik::class);
    }
