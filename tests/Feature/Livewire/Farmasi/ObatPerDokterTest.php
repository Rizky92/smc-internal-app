...
use App\Livewire\Pages\Farmasi\ObatPerDokter;
 ...
 */
class ObatPerDokterTest extends TestCase
{
    private const PERMISSION = 'farmasi.obat-per-dokter.read';

    private function report()
    {
        $petugas = $this->petugasWithPermissions([self::PERMISSION], '99999901');

        return Livewire::actingAs($petugas)->test(ObatPerDokter::class);
    }
