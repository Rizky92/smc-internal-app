...
use App\Livewire\Pages\Farmasi\HppPembelianTerakhir;
 ...
 */
class HppPembelianTerakhirTest extends TestCase
{
    private const PERMISSION = 'farmasi.hpp-pembelian-terakhir.read';

    private function report()
    {
        $petugas = $this->petugasWithPermissions([self::PERMISSION], '99999901');

        return Livewire::actingAs($petugas)->test(HppPembelianTerakhir::class);
    }
