...
use App\Livewire\Pages\Farmasi\RencanaOrder;
 ...
 */
class RencanaOrderTest extends TestCase
{
    private const PERMISSION = 'farmasi.stok-darurat.read';

    private function report()
    {
        $petugas = $this->petugasWithPermissions([self::PERMISSION], '99999901');

        return Livewire::actingAs($petugas)->test(RencanaOrder::class);
    }
