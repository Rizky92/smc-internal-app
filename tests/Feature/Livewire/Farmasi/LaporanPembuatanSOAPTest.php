...
use App\Livewire\Pages\Farmasi\LaporanPembuatanSOAP;
 ...
 */
class LaporanPembuatanSOAPTest extends TestCase
{
    private const PERMISSION = 'farmasi.laporan-pembuatan-soap.read';

    private function report()
    {
        $petugas = $this->petugasWithPermissions([self::PERMISSION], '99999901');

        return Livewire::actingAs($petugas)->test(LaporanPembuatanSOAP::class);
    }
