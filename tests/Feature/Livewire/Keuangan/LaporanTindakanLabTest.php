...
use App\Livewire\Pages\Keuangan\LaporanTindakanLab;
 ...
 */
class LaporanTindakanLabTest extends TestCase
{
    private const PERMISSION = 'keuangan.laporan-tindakan-lab.read';

    private function report()
    {
        $petugas = $this->petugasWithPermissions([self::PERMISSION], '99999901');

        return Livewire::actingAs($petugas)->test(LaporanTindakanLab::class);
    }
