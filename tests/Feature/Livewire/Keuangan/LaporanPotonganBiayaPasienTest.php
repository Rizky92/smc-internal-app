...
use App\Livewire\Pages\Keuangan\LaporanPotonganBiayaPasien;
 ...
 */
class LaporanPotonganBiayaPasienTest extends TestCase
{
    private const PERMISSION = 'keuangan.laporan-potongan-biaya.read';

    private function report()
    {
        $petugas = $this->petugasWithPermissions([self::PERMISSION], '99999901');

        return Livewire::actingAs($petugas)->test(LaporanPotonganBiayaPasien::class);
    }
