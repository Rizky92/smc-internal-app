...
use App\Livewire\Pages\Keuangan\ObatRalanKeRanap;
 ...
 */
class ObatRalanKeRanapTest extends TestCase
{
    private const PERMISSION = 'keuangan.obat-ralan-ke-ranap.read';

    private function report()
    {
        $petugas = $this->petugasWithPermissions([self::PERMISSION], '99999901');

        return Livewire::actingAs($petugas)->test(ObatRalanKeRanap::class);
    }
