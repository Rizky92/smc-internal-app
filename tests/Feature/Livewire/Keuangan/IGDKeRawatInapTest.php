...
use App\Livewire\Pages\Keuangan\IGDKeRawatInap;
 ...
 */
class IGDKeRawatInapTest extends TestCase
{
    private const PERMISSION = 'keuangan.igd-ke-rawat-inap.read';

    private function report()
    {
        $petugas = $this->petugasWithPermissions([self::PERMISSION], '99999901');

        return Livewire::actingAs($petugas)->test(IGDKeRawatInap::class);
    }
