...
use App\Livewire\Pages\Keuangan\StokObatRuangan;
 ...
 */
class StokObatRuanganTest extends TestCase
{
    private const PERMISSION = 'keuangan.stok-obat-ruangan.read';

    private function report()
    {
        $petugas = $this->petugasWithPermissions([self::PERMISSION], '99999901');

        return Livewire::actingAs($petugas)->test(StokObatRuangan::class);
    }
    ...
    {
        $this->report()->set('cari', 'paracetamol')->assertOk();
    }
}
