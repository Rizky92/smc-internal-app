            ...
            <div class="w-full max-w-md space-y-8">
                <div>
                    <img
                        ...
                        alt="Samarinda Medika Citra"
                    />
                    <h1 class="text-center text-emerald-700 mt-2">
                        Samarinda Medika Citra
                    </h1>
                    <h2
                        class="mt-6 text-center text-3xl font-bold tracking-tight text-stone-900"
                    >
                        Silahkan login ke
                        <br />
                        {{ config('app.name') }}
                ...
                >
                    @error('user')
                        <span
                            class="mt-4 block text-center text-sm text-red-500 font-medium"
                        >
                            {{ $message }}
                        </span>
                    @enderror
