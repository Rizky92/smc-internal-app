<div>
    ...
    <x-modal
        id="modal-input-bidang-unit"
        :title="$isUpdating ? 'Edit Bidang' : 'Tambah Bidang Baru'"
        livewire
        centered
    >
        <x-slot name="body" class="p-0" style="overflow-x: hidden">
            <form
                id="form-input-bidang-unit"
                wire:submit.prevent="{{ $bidangId !== -1 ? 'update' : 'create' }}"
            >
