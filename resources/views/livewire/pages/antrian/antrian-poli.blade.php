                            ...
                            <div class="container-toast border shadow" id="callContainer">
                                ...
                                <script>
                                    function checkDataChanges() {
                                        ...
                                        $.ajax({
                                            url: '{{ route('antrian-poli.checkDataChanges', ['kd_poli' => $kd_poli, 'kd_dokter' => $kd_dokter]) }}',
                                            method: 'POST',
                                            data: {
                                                _token: '{{ csrf_token() }}',
                                                lastNoReg: lastNoReg,
                                    ...
                                    function playVoice(noReg, data) {
                                        var textToSpeech = 'Panggilan untuk' + 'Nomor antrian ' + noReg + ',' + 'Silahkan menuju ke' + namaPoli;
