<div wire:init="loadProperties">
    ...
    <x-card use-loading>
        <x-slot name="header">
            ...
            <x-row-col-flex class="mt-2">
                <x-filter.toggle
                    title="Tampilkan Semua Registrasi"
                    model="semuaRegistrasi"
                />
            ...
            >
                <x-slot name="columns">
                    ...
                    <x-table.th
                        style="width: 32ch"
                        name="soapie_ralan"
                        title="S.O.A.P.I.E. Ralan"
                    />
                    <x-table.th
                        style="width: 32ch"
                        name="soapie_ranap"
                        title="S.O.A.P.I.E. Ranap"
                    />
                    <x-table.th
                        style="width: 32ch"
                        name="resume_ralan"
                    ...
                    <x-table.th
                        style="width: 35ch"
                        name="asmed_poli_umum"
                        title="Asmed Poli"
                    />
                    <x-table.th
                        style="width: 35ch"
                        name="asmed_ranap_umum"
                        title="Asmed RWI"
                    />
                    <x-table.th
                        style="width: 32ch"
