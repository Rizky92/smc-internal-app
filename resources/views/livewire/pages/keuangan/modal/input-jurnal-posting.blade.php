<div>
    ...
    <x-modal id="modal-input-posting-jurnal" size="xl" :title="'Posting Jurnal Baru'" livewire centered>
        ...
        <x-slot name="footer" class="justify-content-start">
            ...
            <x-button size="sm" variant="primary" type="submit" class="ml-2" id="simpandata" title="Simpan" icon="fas fa-save" form="form-input-posting-jurnal" :disabled="empty($this->jurnalSementara)" />
        </x-slot>
    </x-modal>
</div>
