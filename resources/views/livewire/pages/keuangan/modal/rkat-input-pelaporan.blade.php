<div>
    ...
    >
        <x-slot name="body" style="overflow-x: hidden">
            <x-form
                id="form-input-pelaporan-rkat"
                livewire
                :submit="$this->isUpdating() ? 'update' : 'create'"
            >
                <x-row-col class="sticky-top bg-white">
                    <div class="form-group">
                        <label for="anggaran-bidang-id">
                            Anggaran bidang digunakan:
                        </label>
                        <x-form.select2
                    ...
                    @if (! $this->isUpdating())
                        <div class="form-group mt-3">
                            ...
                            />
                            <a
                                href="{{ asset('templates/template-import-pelaporan-rkat.xlsx') }}"
                                download
                    ...
                    <div class="form-group mt-3">
                        ...
                        <ul
                            class="p-0 m-0 mt-2 mb-3 d-flex flex-column"
        ...
        <x-slot name="footer" class="justify-content-start">
            @can('keuangan.rkat-pelaporan.update')
                ...
                <x-button
                    ...
                    title="Simpan"
                    icon="fas fa-save"
                    form="form-input-pelaporan-rkat"
                />
            @endcan
        </x-slot>
    </x-modal>
