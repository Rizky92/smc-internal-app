        ...
        <x-slot name="body" class="p-0 pt-3" style="overflow-x: hidden">
            ...
            <x-row-col class="px-3">
                <x-callout variant="warning">
                    ...
                    <x-slot name="content">
                        Mengubah tanggal jurnal dapat mempengaruhi kegiatan
                        penjurnalan yang sedang berjalan.
                    </x-slot>
                </x-callout>
            </x-row-col>
            <x-navtabs livewire class="pt-3" selected="ubah-tgl-jurnal">
                ...
                <x-slot name="contents">
                    <x-navtabs.content id="ubah-tgl-jurnal">
                        <form
                            wire:submit.prevent="updateTglJurnal"
                            class="px-3"
                            id="form-ubah-tgl-jurnal"
                        >
                            <x-row>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label class="text-sm" for="no-jurnal">
                                            No. Jurnal
                                        </label>
                                        <input
                                            type="text"
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label class="text-sm" for="no-bukti">
                                            No. Bukti
                                        </label>
                                        <input
                                            type="text"
                            ...
                            <x-row>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="text-sm" for="keterangan">
                                            Keterangan
                                        </label>
                                        <textarea
                                            class="form-control form-control-sm"
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            class="form-control form-control-sm"
                                            id="tgl-jurnal-lama"
                                            wire:model.defer="tglJurnalLama"
                                            readonly
                                            autocomplete="off"
                                        />
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            id="tgl-jurnal-baru"
                                            autocomplete="off"
                                            wire:model.defer="tglJurnalBaru"
                                        />
                                    </div>
                                </div>
                            </x-row>
