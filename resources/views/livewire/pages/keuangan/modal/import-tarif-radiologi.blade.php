    ...
    @push('js')
        <script>
            ...
            $(document).on('data-saved', () => {
                $('#modal-import-tarif-radiologi').modal('hide');
            });
        </script>
    @endpush

    <x-modal id="modal-import-tarif-radiologi" title="Import Tarif Radiologi" livewire centered>
        <x-slot name="body">
            <x-flash class="mx-3 mt-3" />
            <x-form id="form-import-tarif-radiologi" livewire wire:submit.prevent="importData">
                <x-form.import-file id="upload-tarif-radiologi" model="fileImport" accept=".xlsx, .xls" template="templates/template-import-tarif-radiologi.xlsx" />
            </x-form>
        </x-slot>
        <x-slot name="footer" class="justify-content-start">
            ...
            <x-button
                ...
                form="form-import-tarif-radiologi"
