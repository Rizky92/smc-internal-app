        ...
        <x-slot name="header">
            ...
            <x-row-col-flex class="mt-2">
                ...
                <x-filter.select2
                    livewire
                    name="tanggalTarikan"
                    event="data-tarikan:updated"
                    class="ml-3"
                    :options="$this->dataTanggalTarikan"
                    placeholder="-"
                    placeholder-value="-"
                    width="20rem"
                />
                ...
                <x-slot name="contents">
                    <x-navtabs.content id="faktur">
                        ...
                        <x-paginator
                            ...
                            :data="$this->dataLaporanFakturPajak"
                        />
                    </x-navtabs.content>
                    <x-navtabs.content id="detailfaktur">
                        ...
                        >
                            <x-slot name="columns">
                                ...
                                />
                                <x-table.th
                                    name="jenis_barang_jasa"
                                    title="Jenis Barang/Jasa"
                                />
                                <x-table.th
                                    name="kode_barang_jasa"
                                    title="Kode Barang/Jasa"
                                />
                                <x-table.th
                                ...
                                />
                                <x-table.th
                                    name="nama_satuan_ukur"
                                    title="Nama Satuan Ukur"
                                />
                                <x-table.th-money
                                    align="right"
                                    name="harga_satuan"
                        ...
                        <x-paginator
                            class="px-4 py-3 bg-light"
                            :data="$this->dataDetailFakturPajak"
                        />
                    </x-navtabs.content>
                </x-slot>
            </x-navtabs>
