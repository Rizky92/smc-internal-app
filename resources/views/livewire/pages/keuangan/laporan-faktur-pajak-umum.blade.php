                    ...
                    <x-navtabs.content id="faktur">
                        <x-table :sortColumns="$sortColumns" style="width: 310rem" sortable zebra hover sticky nowrap>
                            <x-slot name="columns">
                                ...
                                <x-table.th name="telp_asuransi" title="No. Telp Asuransi" />
                                <x-table.th name="email_asuransi" title="Email Asuransi" />
                                <x-table.th name="npwp_asuransi" title="NPWP Asuransi" />
                                <x-table.th name="kode_perusahaan" title="Kode Perusahaan" />
                                <x-table.th name="nama_perusahaan" title="Nama Perusahaan" />
                                <x-table.th name="alamat_perusahaan" title="Alamat Perusahaan" />
                                <x-table.th name="telp_perusahaan" title="No. Telp Perusahaan" />
                                <x-table.th name="email_perusahaan" title="Email Perusahaan" />
                                <x-table.th name="npwp_perusahaan" title="NPWP Perusahaan" />
                            </x-slot>
                            <x-slot name="body">
