<div wire:init="loadProperties">
    ...
    <x-card use-loading>
        <x-slot name="header">
            @canany(['dapur.input-minmax-stok.create', 'dapur.input-minmax-stok.update'])
                <x-row>
        ...
        <x-slot name="body">
            <x-table :sortColumns="$sortColumns" sortable zebra hover sticky nowrap>
                ...
                <x-slot name="body">
                    @forelse ($this->barangDapur as $barang)
                        <x-table.tr>
                            <x-table.td
                                clickable
                                data-kode-barang="{{ $barang->kode_brng }}"
                                data-nama-barang="{{ $barang->nama_brng }}"
                                data-kode-supplier="{{ $barang->kode_suplier }}"
        ...
        <x-slot name="footer">
            <x-paginator :data="$this->barangDapur" />
        </x-slot>
    </x-card>
</div>
