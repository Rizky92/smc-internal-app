<div>
    ...
    <x-modal
        livewire
        title="Transfer perizinan SIAP ke user lainnya"
        id="modal-transfer-perizinan"
    >
            ...
            <x-row-col class="px-3 pt-3">
                ...
                >
                    ...
                    <div class="w-50">
                        ...
                        <ul
                            class="d-flex flex-wrap p-0 m-0 text-xs"
                            style="
                                list-style: none;
                                row-gap: 0.5rem;
                                column-gap: 0.25rem;
                        ...
                        >
                            @foreach ($roles as $roleId => $role)
                                <li
                                    class="badge badge-dark text-sm font-weight-normal border"
                                >
                                    {{ $role }}
                                </li>
                            @endforeach
                            ...
                            @foreach ($permissions as $permissionId => $permission)
                                <li
                                    class="badge badge-light text-sm font-weight-normal border"
                                >
                                    {{ $permission }}
                                </li>
                            @endforeach
                            ...
                            <x-table.tr>
                                ...
                                <x-table.td>
                                    @foreach ($user->roles as $userRole)
                                        <span
                                            class="badge badge-dark font-weight-normal border"
                                        >
                                            {{ $userRole->name }}
                                        </span>
                                    @endforeach
