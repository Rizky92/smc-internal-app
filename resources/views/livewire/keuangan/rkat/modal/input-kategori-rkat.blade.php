<div>
    ...
    <x-modal id="modal-input-kategori-rkat" :title="$isUpdating ? 'Edit Kategori Anggaran' : 'Tambah Kategori Anggaran Baru'" livewire centered>
        <x-slot name="body" class="p-0" style="overflow-x: hidden">
            <form id="form-input-kategori-rkat" wire:submit.prevent="{{ $anggaranId !== -1 ? 'update' : 'create' }}">
