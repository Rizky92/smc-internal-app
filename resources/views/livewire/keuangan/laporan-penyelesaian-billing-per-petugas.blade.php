<div>
    ...
    <x-card use-default-filter>
        <x-slot name="body" class="table-responsive">
            <x-table style="min-width: 100%; width: 160rem" sortable :sortColumns="$sortColumns">
                <x-slot name="columns">
                    <x-table.th name="no_rawat" title="No. Rawat" style="width: 20ch" />
                    <x-table.th name="tgl_registrasi" title="Tgl. Daftar" style="width: 20ch" />
                    <x-table.th name="jam_reg" title="Jam" style="width: 20ch" />
